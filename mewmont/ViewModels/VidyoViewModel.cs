...
namespace mewmont
{
    public class VidyoViewModel : INotifyPropertyChanged
    {
        private static VidyoViewModel _instance = new VidyoViewModel();
        public static VidyoViewModel GetInstance() { return _instance; }
        private VidyoViewModel()
        {
        ...
        string _token = "cHJvdmlzaW9uAHVzZXIxQGVhZTNlYy52aWR5by5pbwA2MzcwNzUzMDM4MwAAYWZjODgzNGM1MGUxOWVjYTQ3MTRlNDY3YjRlMmViNGRiMjE5ZmVjNGVhNTRjYTM0OWE4YzI1OWE4Y2Q0NjViMDlmNTAzMmE3YzRlMWY1MGNhZmRmOGEwMmY4N2JhYWNh"; // INSERT VALID TOKEN
        string _displayName = "user1";
