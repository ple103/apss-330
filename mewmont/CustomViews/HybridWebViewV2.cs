...
{
    /// <summary>
    /// A web view that enables JavaScript & C# communication. This is a patched version of the HybridWebView class from Xlabs
    /// to fix horrifically outdated shenanigans breaking video codecs that require hardware acceleration.
    /// </summary>
    public class HybridWebViewV2 : View
    {
        /// <summary>
        /// The uri property.
        /// </summary>
        ...
        public HybridWebViewV2() : this((Resolver.IsSet ? Resolver.Resolve<IJsonSerializer>() : null)
                ?? DependencyService.Get<IJsonSerializer>() ?? new XLabs.Serialization.JsonNET.JsonSerializer())
        {
        }
        ...
        public HybridWebViewV2(IJsonSerializer jsonSerializer)
        {
