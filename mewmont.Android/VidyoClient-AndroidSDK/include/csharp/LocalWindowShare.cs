...
namespace VidyoClient
{
	public class LocalWindowShare{
		...
		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoLocalWindowShareSetPreviewLabelNative(IntPtr w, [MarshalAs(UnmanagedType.LPStr)]String previewLabel);
		...
		public Boolean SetPreviewLabel(String previewLabel){
			...
			Boolean ret = VidyoLocalWindowShareSetPreviewLabelNative(objPtr, previewLabel);
