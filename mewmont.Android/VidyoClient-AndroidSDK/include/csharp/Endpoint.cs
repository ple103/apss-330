...
namespace VidyoClient
{
	public class Endpoint{
		...
		private static extern void VidyoEndpointAppLogNative(IntPtr e, [MarshalAs(UnmanagedType.I4)]ClientAppLogLevel logLevel, [MarshalAs(UnmanagedType.LPStr)]String logMsg);
		...
		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoEndpointEnableFileLoggerNative(IntPtr e, [MarshalAs(UnmanagedType.LPStr)]String logFileName, [MarshalAs(UnmanagedType.LPStr)]String logFileFilter);
		...
		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoEndpointSetFileLoggerFilterNative(IntPtr e, [MarshalAs(UnmanagedType.LPStr)]String logFileFilter);
		...
		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoEndpointSetLicenseKeyNative(IntPtr e, [MarshalAs(UnmanagedType.LPStr)]String licenseKey);
		...
		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoEndpointSetPoolNative(IntPtr e, [MarshalAs(UnmanagedType.LPStr)]String name);
		...
		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoEndpointSetTURNAddressCredentialsNative(IntPtr e, [MarshalAs(UnmanagedType.LPStr)]String turnAddress, uint port, [MarshalAs(UnmanagedType.LPStr)]String username, [MarshalAs(UnmanagedType.LPStr)]String password, [MarshalAs(UnmanagedType.I4)]EndpointBaseTransportType baseTransport);
		...
		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoEndpointValidateLicenseKeyNative(IntPtr e, [MarshalAs(UnmanagedType.LPStr)]String licenseKey, [MarshalAs(UnmanagedType.LPStr)]String userName);
		...
		public Endpoint(IntPtr viewId, LocalRenderer.LocalRendererViewStyle viewStyle, uint remoteParticipants, String consoleLogFilter, String logFileFilter, String logFileName){
			objPtr = VidyoEndpointConstructNative(ref viewId, viewStyle, remoteParticipants, consoleLogFilter, logFileFilter, logFileName);
		...
		public void AppLog(ClientAppLogLevel logLevel, String logMsg){
			...
			VidyoEndpointAppLogNative(objPtr, logLevel, logMsg);
		}
		...
		public Boolean EnableFileLogger(String logFileName, String logFileFilter){
			...
			Boolean ret = VidyoEndpointEnableFileLoggerNative(objPtr, logFileName, logFileFilter);
		...
		public Boolean SetFileLoggerFilter(String logFileFilter){
			...
			Boolean ret = VidyoEndpointSetFileLoggerFilterNative(objPtr, logFileFilter);
		...
		public Boolean SetLicenseKey(String licenseKey){
			...
			Boolean ret = VidyoEndpointSetLicenseKeyNative(objPtr, licenseKey);
		...
		public Boolean SetPool(String name){
			...
			Boolean ret = VidyoEndpointSetPoolNative(objPtr, name);
		...
		public Boolean SetTURNAddressCredentials(String turnAddress, uint port, String username, String password, EndpointBaseTransportType baseTransport){
			...
			Boolean ret = VidyoEndpointSetTURNAddressCredentialsNative(objPtr, turnAddress, port, username, password, baseTransport);
		...
		public Boolean ValidateLicenseKey(String licenseKey, String userName){
			...
			Boolean ret = VidyoEndpointValidateLicenseKeyNative(objPtr, licenseKey, userName);
