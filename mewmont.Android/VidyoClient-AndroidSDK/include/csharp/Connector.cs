...
namespace VidyoClient
{
	public class Connector{
		...
		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoConnectorConnectToRoomAsGuestNative(IntPtr c, [MarshalAs(UnmanagedType.LPStr)]String host, [MarshalAs(UnmanagedType.LPStr)]String displayName, [MarshalAs(UnmanagedType.LPStr)]String roomKey, OnSuccess onSuccess, OnFailure onFailure, OnDisconnected onDisconnected);

		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoConnectorConnectToRoomWithIdNative(IntPtr c, [MarshalAs(UnmanagedType.LPStr)]String host, [MarshalAs(UnmanagedType.LPStr)]String userName, [MarshalAs(UnmanagedType.LPStr)]String password, [MarshalAs(UnmanagedType.LPStr)]String roomId, OnSuccess onSuccess, OnFailure onFailure, OnDisconnected onDisconnected);

		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoConnectorConnectToRoomWithKeyNative(IntPtr c, [MarshalAs(UnmanagedType.LPStr)]String host, [MarshalAs(UnmanagedType.LPStr)]String userName, [MarshalAs(UnmanagedType.LPStr)]String password, [MarshalAs(UnmanagedType.LPStr)]String roomKey, OnSuccess onSuccess, OnFailure onFailure, OnDisconnected onDisconnected);

		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoConnectorConnectToRoomWithTokenAndIdNative(IntPtr c, [MarshalAs(UnmanagedType.LPStr)]String host, [MarshalAs(UnmanagedType.LPStr)]String userName, [MarshalAs(UnmanagedType.LPStr)]String token, [MarshalAs(UnmanagedType.LPStr)]String roomId, OnSuccess onSuccess, OnFailure onFailure, OnDisconnected onDisconnected);

		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoConnectorConnectToRoomWithTokenAndKeyNative(IntPtr c, [MarshalAs(UnmanagedType.LPStr)]String host, [MarshalAs(UnmanagedType.LPStr)]String userName, [MarshalAs(UnmanagedType.LPStr)]String token, [MarshalAs(UnmanagedType.LPStr)]String roomKey, OnSuccess onSuccess, OnFailure onFailure, OnDisconnected onDisconnected);
		...
		public Boolean ConnectToRoomAsGuest(String host, String displayName, String roomKey, IConnect _iIConnect){
			_mIConnect = _iIConnect;
			_mOnSuccess = OnSuccessDelegate;
			_mOnFailure = OnFailureDelegate;
			_mOnDisconnected = OnDisconnectedDelegate;

			Boolean ret = VidyoConnectorConnectToRoomAsGuestNative(objPtr, host, displayName, roomKey, _mOnSuccess, _mOnFailure, _mOnDisconnected);

			return ret;
		}
		public Boolean ConnectToRoomWithId(String host, String userName, String password, String roomId, IConnect _iIConnect){
			_mIConnect = _iIConnect;
			_mOnSuccess = OnSuccessDelegate;
			_mOnFailure = OnFailureDelegate;
			_mOnDisconnected = OnDisconnectedDelegate;

			Boolean ret = VidyoConnectorConnectToRoomWithIdNative(objPtr, host, userName, password, roomId, _mOnSuccess, _mOnFailure, _mOnDisconnected);

			return ret;
		}
		public Boolean ConnectToRoomWithKey(String host, String userName, String password, String roomKey, IConnect _iIConnect){
			_mIConnect = _iIConnect;
			_mOnSuccess = OnSuccessDelegate;
			_mOnFailure = OnFailureDelegate;
			_mOnDisconnected = OnDisconnectedDelegate;

			Boolean ret = VidyoConnectorConnectToRoomWithKeyNative(objPtr, host, userName, password, roomKey, _mOnSuccess, _mOnFailure, _mOnDisconnected);

			return ret;
		}
		public Boolean ConnectToRoomWithTokenAndId(String host, String userName, String token, String roomId, IConnect _iIConnect){
			_mIConnect = _iIConnect;
			_mOnSuccess = OnSuccessDelegate;
			_mOnFailure = OnFailureDelegate;
			_mOnDisconnected = OnDisconnectedDelegate;

			Boolean ret = VidyoConnectorConnectToRoomWithTokenAndIdNative(objPtr, host, userName, token, roomId, _mOnSuccess, _mOnFailure, _mOnDisconnected);

			return ret;
		}
		public Boolean ConnectToRoomWithTokenAndKey(String host, String userName, String token, String roomKey, IConnect _iIConnect){
			_mIConnect = _iIConnect;
			_mOnSuccess = OnSuccessDelegate;
			_mOnFailure = OnFailureDelegate;
			_mOnDisconnected = OnDisconnectedDelegate;

			Boolean ret = VidyoConnectorConnectToRoomWithTokenAndKeyNative(objPtr, host, userName, token, roomKey, _mOnSuccess, _mOnFailure, _mOnDisconnected);
...
[ObjCRuntime.MonoPInvokeCallback(typeof(OnWebProxyCredentialsRequest))]
		...
		private static void OnWebProxyCredentialsRequestDelegate(IntPtr c, IntPtr webProxyAddress){
			if(_mIRegisterWebProxyEventListener != null)
				_mIRegisterWebProxyEventListener.OnWebProxyCredentialsRequest(Marshal.PtrToStringAnsi(webProxyAddress));
		}
#if __IOS__
