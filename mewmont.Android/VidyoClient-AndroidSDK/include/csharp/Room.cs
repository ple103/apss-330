...
namespace VidyoClient
{
	public class Room{
		...
		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoRoomBootAllParticipantsNative(IntPtr r, [MarshalAs(UnmanagedType.LPStr)]String reason);

		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoRoomBootParticipantNative(IntPtr r, [MarshalAs(UnmanagedType.LPStr)]String userId, [MarshalAs(UnmanagedType.LPStr)]String reason);

		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoRoomCancelInviteNative(IntPtr r, [MarshalAs(UnmanagedType.LPStr)]String inviteeId);
		...
		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoRoomEnterNative(IntPtr r, [MarshalAs(UnmanagedType.LPStr)]String password, OnEntered onEntered, OnExited onExited);
		...
		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoRoomInviteNative(IntPtr r, [MarshalAs(UnmanagedType.LPStr)]String userId, [MarshalAs(UnmanagedType.LPStr)]String message, OnInviteResult onInviteResult);

		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoRoomInviteAllNative(IntPtr r, [MarshalAs(UnmanagedType.LPStr)]String message, OnInviteResult onInviteResult);

		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoRoomInviteNNative(IntPtr r, IntPtr userIds, [MarshalAs(UnmanagedType.LPStr)]String message, OnInviteResult onInviteResult);
		...
		public class RoomProperties{
			...
			public RoomProperties(IntPtr obj){
				...
				calendarInviteBody = Marshal.PtrToStringAnsi(VidyoRoomPropertiesGetcalendarInviteBodyNative(objPtr));
				calendarInviteHTMLBody = Marshal.PtrToStringAnsi(VidyoRoomPropertiesGetcalendarInviteHTMLBodyNative(objPtr));
				calendarInviteSubject = Marshal.PtrToStringAnsi(VidyoRoomPropertiesGetcalendarInviteSubjectNative(objPtr));
				...
				designatedPresenter = Marshal.PtrToStringAnsi(VidyoRoomPropertiesGetdesignatedPresenterNative(objPtr));
				...
				loggingLocation = Marshal.PtrToStringAnsi(VidyoRoomPropertiesGetloggingLocationNative(objPtr));
				maxParticipants = VidyoRoomPropertiesGetmaxParticipantsNative(objPtr);
				members = csMembers;
				moderatorUrl = Marshal.PtrToStringAnsi(VidyoRoomPropertiesGetmoderatorUrlNative(objPtr));
				...
				schedule = csSchedule;
				webLink = Marshal.PtrToStringAnsi(VidyoRoomPropertiesGetwebLinkNative(objPtr));
		...
		public Boolean BootAllParticipants(String reason){
			...
			Boolean ret = VidyoRoomBootAllParticipantsNative(objPtr, reason);

			return ret;
		}
		public Boolean BootParticipant(String userId, String reason){

			Boolean ret = VidyoRoomBootParticipantNative(objPtr, userId, reason);

			return ret;
		}
		public Boolean CancelInvite(String inviteeId){

			Boolean ret = VidyoRoomCancelInviteNative(objPtr, inviteeId);
		...
		public Boolean Enter(String password, IEnter _iIEnter){
			...
			Boolean ret = VidyoRoomEnterNative(objPtr, password, _mOnEntered, _mOnExited);
		...
		public Boolean Invite(String userId, String message, IInvite _iIInvite){
			...
			Boolean ret = VidyoRoomInviteNative(objPtr, userId, message, _mOnInviteResult);
		...
		public Boolean InviteAll(String message, IInvite _iIInvite){
			...
			Boolean ret = VidyoRoomInviteAllNative(objPtr, message, _mOnInviteResult);
		...
		public Boolean InviteN(List<String> userIds, String message, IInvite _iIInvite){
			...
			Boolean ret = VidyoRoomInviteNNative(objPtr, nUserIds, message, _mOnInviteResult);
...
[ObjCRuntime.MonoPInvokeCallback(typeof(OnInviteResult))]
		...
		private static void OnInviteResultDelegate(IntPtr room, IntPtr inviteeId, RoomInviteResult result){
			if(_mIInvite != null)
				_mIInvite.OnInviteResult(Marshal.PtrToStringAnsi(inviteeId), result);
		}
#if __IOS__
