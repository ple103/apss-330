...
[assembly: ExportRenderer(typeof(HybridWebViewV2), typeof(HybridWebViewRendererV2))]

namespace mewmont
{
    /// <summary>
    /// Class HybridWebViewRendererV2 Patched from Xlab's HybridWebViewRenderer to prevent horifically outdated shenanigans from breaking YouTube videos from playing
    /// on hardware codecs.
    /// </summary>
    public partial class HybridWebViewRendererV2 : ViewRenderer<HybridWebViewV2, HybridWebViewRendererV2.NativeWebView>
    {

        public HybridWebViewRendererV2(Context context)
            : base(context)
        {
        ...
        /// </summary>
        public static Func<HybridWebViewRendererV2, Client> GetWebViewClientDelegate;

        /// <summary>
        /// Allows one to override the Chrome Client class without a custom renderer.
        /// </summary>
        public static Func<HybridWebViewRendererV2, ChromeClient> GetWebChromeClientDelegate;
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<HybridWebViewV2> e)
        {
            ...
            if (this.Control == null && e.NewElement != null)
            {
                ...
                //webView.SetLayerType(e.NewElement.AndroidHardwareRendering? LayerType.Hardware : LayerType.Hardware, null);
        ...
        partial void LoadFromContent(object sender, HybridWebViewV2.LoadContentEventArgs contentArgs)
        {
        ...
        partial void LoadContent(object sender, HybridWebViewV2.LoadContentEventArgs contentArgs)
        {
            if (Control != null)
            {
        ...
        public class Client : WebViewClient
        {
            ...
            /// The web hybrid
            /// </summary>
            protected readonly WeakReference<HybridWebViewRendererV2> WebHybrid;
            ...
            public override void OnPageFinished(WebView view, string url)
            {
                ...
                HybridWebViewRendererV2 hybrid;
        ...
        public class Xamarin : Object
        {
            ...
            /// The web hybrid.
            /// </summary>
            private readonly WeakReference<HybridWebViewRendererV2> webHybrid;
